...
/// @nodoc
abstract class $UnionPageCopyWith<T, $Res> {
  factory $UnionPageCopyWith(
          UnionPage<T> value, $Res Function(UnionPage<T>) then) =
      _$UnionPageCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$UnionPageCopyWithImpl<T, $Res> implements $UnionPageCopyWith<T, $Res> {
  _$UnionPageCopyWithImpl(this._value, this._then);

  final UnionPage<T> _value;
  // ignore: unused_field
  final $Res Function(UnionPage<T>) _then;
}
...
/// @nodoc
class __$$DataCopyWithImpl<T, $Res> extends _$UnionPageCopyWithImpl<T, $Res>
...
class _$Data<T> implements Data<T> {
  ...
  @override
  String toString() {
    return 'UnionPage<$T>(value: $value)';
  }
...
abstract class Data<T> implements UnionPage<T> {
...
/// @nodoc
class __$$LoadingCopyWithImpl<T, $Res> extends _$UnionPageCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements UnionPage<T> {
...
/// @nodoc
class __$$ErrorCopyWithImpl<T, $Res> extends _$UnionPageCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'UnionPage<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements UnionPage<T> {
